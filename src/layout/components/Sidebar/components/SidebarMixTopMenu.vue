...
settingsStore.changeActiveTopMenuPath(activeTopMenuPath);

// 激活的顶部菜单路径
const activePath = computed(() => settingsStore.activeTopMenuPath);
...
const handleMenuSelect = (routePath: string) => {
  settingsStore.changeActiveTopMenuPath(routePath);
